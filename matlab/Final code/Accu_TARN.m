...
% ask_NORM2_BS = NORM2(model1.param,model1.name,S0,Data,1000);
%%  Merton
...
% ask_NORM2_Mer = NORM2(model2.param,model2.name,S0,Data,1000);
%%  Kou
...
% ask_NORM2_Kou = NORM2(model3.param,model3.name,S0,Data,1000);
%%  NIG
...
% ask_NORM2_NIG = NORM2(model4.param,model4.name,S0,Data,1000);
%%  VG
...
% ask_NORM2_VG = NORM2(model5.param,model5.name,S0,Data,1000);
